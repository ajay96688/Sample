...
import ExpandableHeaderComponent from './ExpandableHeaderComponent.jsx';
                    ...
                    <div style={{height: 400, width: 900}} className="ag-fresh">
                        ...
                        >
                            <AgGridColumn headerName="#" width={30} checkboxSelection suppressSorting suppressMenu suppressFilter pinned></AgGridColumn>
                                <AgGridColumn field="name" width={150} enableRowGroup enablePivot pinned editable cellEditorFramework={NameCellEditor} headerComponentFramework={ExpandableHeaderComponent}></AgGridColumn>
